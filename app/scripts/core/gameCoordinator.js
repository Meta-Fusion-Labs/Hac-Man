import Pacman from './path/to/Pacman';
import Ghost from './path/to/Ghost';
import CharacterUtil from './path/to/CharacterUtil';
import Pickup from './path/to/Pickup';
import SoundManager from './path/to/SoundManager';
import GameEngine from './path/to/GameEngine';
import Timer from './path/to/Timer'; // Add this line to import Timer // Add this line to import CharacterUtil // Adjust the path as necessary
